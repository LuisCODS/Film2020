            ...
            <div class="col-md">               
                 <form id="formCreate" action="../../controller/membreController.php" method="POST" >
                      ...
                      <div class="form-group">
                            ...
                            <input autofocus size="40" type="text" class="form-control" name="nom" id="nom" required>
                            <p id="erreurNom" style='color:red'></p>
                      </div>
                      <div class="form-group">
                            <label for="prenom">Prenom</label>
                            <input  size="40" type="text" class="form-control" name="prenom" required>
                            <p id="erreurIsVide" style='color:red'></p>
                      </div>
                      <div class="form-group">
                            <label for="courriel">Courriel</label>
                            <input required id="courriel"size="40" type="email" class="form-control" name="courriel">
                      ...
                      <div class="form-group">
                            ...
                            <input  type="password" class="form-control" id="MDP_membreConfirm" name="MDP_membreConfirm" required>
                             <p id="erreurPasswordConfirm" style='color:red'></p>
                      </div> 
                      <button type="submit" class="btn btn-primary" onclik="return validerForm();">Enregistrer</button>
                </form>     
            </div>
       </div>
    </div>  
