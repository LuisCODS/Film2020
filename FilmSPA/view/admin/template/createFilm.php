...
<div class="container" id="formCreateFilm" style="display: flex;justify-content: center;">    

 <form id="formCreateFilm" enctype="multipart/form-data" 
        style="width: 50%;" 
         action="../../controller/admin.php" 
         method="POST">        
    <h2>Nouveau film</h2>
